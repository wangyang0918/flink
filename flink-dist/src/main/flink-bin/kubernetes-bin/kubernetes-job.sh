...
JOB_MODE_ARGS="-Dexecution.target=kubernetes-job-cluster"
$JAVA_RUN $JVM_ARGS -classpath "$CC_CLASSPATH" $log_setting org.apache.flink.kubernetes.cli.FlinkKubernetesCustomCli "$JOB_MODE_ARGS" "$@"
