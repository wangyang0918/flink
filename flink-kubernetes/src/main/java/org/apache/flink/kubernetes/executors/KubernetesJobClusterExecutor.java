 ...
 */
@Internal
public class KubernetesJobClusterExecutor extends AbstractJobClusterExecutor<String, KubernetesClusterClientFactory> {

	public static final String NAME = "kubernetes-job-cluster";

	public KubernetesJobClusterExecutor() {
