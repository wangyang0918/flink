...
public class TestingStateHandleStore<T extends Serializable> implements StateHandleStore<T, IntegerResourceVersion> {
	...
	private final RunnableWithException removeAllHandlesRunnable;
	...
	private TestingStateHandleStore(
			...
			RunnableWithException removeAllHandlesRunnable,
		...
		this.removeAllHandlesRunnable = removeAllHandlesRunnable;
	...
	public static class Builder<T extends Serializable> {
		...
		private RunnableWithException removeAllHandlesRunnable = () -> {};
		...
		public Builder<T> setRemoveAllHandlesRunnable(RunnableWithException removeAllHandlesRunnable) {
			this.removeAllHandlesRunnable = removeAllHandlesRunnable;
			return this;
		}
